...
export class CreatePetRadarTables1750000000000 implements MigrationInterface {
  name = 'CreatePetRadarTables1750000000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Habilitar extensión PostGIS (por si no está activa)
